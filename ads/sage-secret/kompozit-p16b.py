...
PLAKA = os.path.join(KOK, 'frames', 'p16b')
UI = os.path.join(KOK, 'frames', 'p16ui')
CIKTI = os.path.join(KOK, 'frames', 'p16bout')

# SOL-UST, SAG-UST, SAG-ALT, SOL-ALT  (3 px iceri alindi: cam kenari kalsin)
QUAD = [(756, 746), (956, 894), (742, 1230), (541, 1082)]
...
def hazirla(ui):
    ...
    ui = ui.convert('RGB')
    w, h = ui.size
    ui = ui.crop((0, 60, w, 1799))             # durum/gezinme + cark merkezli
    w, h = ui.size
    hedef = _hedef_oran()
