...
TABLOLAR = [
    ...
    "TRIGRAM_FAMILY_NAMES", "TRIGRAM_ATTRIBUTE_NAMES",
    "ELEMENT_RELATION_NAMES", "LIU_QIN_NAMES", "ICHING_METHOD_NAMES",
    "TRANSIT_EVENT_NAMES", "DECLINATION_ASPECT_NAMES",
    "MOVEMENT_NAMES", "ASTRO_NOTES",
]
